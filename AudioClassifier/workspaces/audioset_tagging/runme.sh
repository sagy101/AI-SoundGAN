...
#TODO: change DATASET_DIR & WORKSPACE fit our data & workspace
...
#TODO: change to fit our meta data
...
echo "------ Download wavs ------"
#TODO: change download to our dataset
...
#TODO: change to fit above data (download)
...
#TODO: change whole code to fit only eval hdf5 file and balanced training hdf5 file (no unbalanced)!!!
